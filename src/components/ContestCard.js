...
//   // Dates from backend
//   const startDate = contest.startDate ? new Date(contest.startDate).toLocaleString() : "N/A";
//   const endDate = contest.endDate ? new Date(contest.endDate).toLocaleString() : "N/A";
...
//   infoContainer: { flex: 1, flexDirection: "row", justifyContent: "space-between", paddingLeft: 10 },
//   infoLeft: { flex: 2 },
