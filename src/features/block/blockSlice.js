...
// // Async thunks with direct API calls
// export const blockUser = createAsyncThunk(
//   'block/blockUser',
//   async ({ userId, reason }, { rejectWithValue }) => {
//     try {
//       const response = await api.post(`/block/block/block/${userId}`, { reason });
...
//     try {
//       const response = await api.post(`/block/block/unblock/${userId}`);
//       return response.data;
//     } catch (error) {
//       return rejectWithValue(
...
//     try {
//       const response = await api.post(`/block/block/not-interested/${postId}`);
//       return response.data;
//     } catch (error) {
//       return rejectWithValue(
...
//     try {
//       const response = await api.get('/block/block/blocked-list');
//       return response.data;
//     } catch (error) {
//       return rejectWithValue(
...
//   async (userId, { rejectWithValue }) => {
//     try {
//       const response = await api.get(`/block/block/check-block/${userId}`);
...
//     error: null,
//     notInterestedPosts: [],
//     blockStatus: {}, // Store block status for different users
//   },
//   reducers: {
//     clearError: (state) => {
//       state.error = null;
...
//         // Update block status for this user
...
// export const selectBlockStatus = (state, userId) => state.block.blockStatus[userId] || { 
//   isBlockedByMe: false, 
//   amIBlocked: false 
// };
// export const selectIsBlockedByMe = (state, userId) => 
//   state.block.blockStatus[userId]?.isBlockedByMe || false;
// export const selectAmIBlocked = (state, userId) => 
//   state.block.blockStatus[userId]?.amIBlocked || false;
...
// // Async thunks with direct API calls - FIXED ENDPOINTS
// export const blockUser = createAsyncThunk(
//   'block/blockUser',
//   async ({ userId, reason }, { rejectWithValue }) => {
//     try {
//       // ✅ Fixed endpoint: /block/:id instead of /block/block/:id
